![docker image](https://github.com/PauloGitHB/nomad-oasis/actions/workflows/docker-publish.yml/badge.svg)


# PauloGitHB's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of PauloGitHB.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/PauloGitHB/nomad-oasis.git
    cd nomad-oasis
    ```
    ...
    ```sh
    curl-L -o nomad-oasis.zip "https://github.com/PauloGitHB/nomad-oasis/archive/main.zip"
...
your `docker-compose.yaml` with `ghcr.io/paulogithb/nomad-oasis:main` for the services
...
```
docker pull ghcr.io/paulogithb/nomad-oasis/jupyter:main
```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/PauloGitHB/nomad-oasis/manifests/main": unauthorized`
